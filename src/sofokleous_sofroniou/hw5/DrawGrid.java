...
/**
 * This class's role is to draw on the canvas the grid and the people on it
 * each person is represented by one dot with different colors according to their
 * condition.
 * 
...
public class DrawGrid {
	static int I;
	/**
	 * Method to draw the grid representing the space where people will
	 * move
	 * 
